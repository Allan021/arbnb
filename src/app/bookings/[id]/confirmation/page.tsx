      ...
      <main className="flex min-h-screen flex-col">
        ...
        <div className="container mx-auto px-4 py-8 flex-grow">
          <div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
            <span className="block sm:inline">{error || 'No se pudo encontrar la reserva'}</span>
          </div>
        </div>
        <Footer />
      </main>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-lg">
          ...
          <div className="border-t border-b py-6 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p>{booking.property?.address?.city || 'Ciudad'}, {booking.property?.address?.country || 'País'}</p>
              </div>
              <div>
          ...
          <div className="text-center space-y-4">
            <p className="text-gray-600">Recibirás un correo electrónico con todos los detalles de tu reserva.</p>
